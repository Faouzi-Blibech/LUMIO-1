      ...
      <header className="sticky top-0 z-50 border-b border-border bg-card/80 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto flex items-center justify-between h-14 px-6">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xs font-body font-medium text-warning bg-warning/8 px-2 py-0.5 rounded-lg">Admin</span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 rounded-xl bg-warning/10 flex items-center justify-center font-heading font-bold text-warning text-sm">
